...
var file_content_content_proto_rawDesc = []byte{
	...
	0x74, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x27, 0x0a, 0x0a, 0x54, 0x61, 0x67, 0x52,
	...
	0x65, 0x6c, 0x61, 0x74, 0x65, 0x64, 0x22, 0x7d, 0x0a, 0x05, 0x51, 0x75, 0x65, 0x72, 0x79, 0x12,
	...
	0x0d, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x64, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x22, 0xed,
	0x01, 0x0a, 0x0d, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x64, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74,
	...
	0x73, 0x18, 0x08, 0x20, 0x01, 0x28, 0x05, 0x52, 0x05, 0x76, 0x6f, 0x74, 0x65, 0x73, 0x22, 0x2a,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x74, 0x6f, 0x22, 0xec, 0x01, 0x0a, 0x07, 0x43,
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x75, 0x72, 0x69, 0x12, 0x23, 0x0a, 0x04, 0x64,
	...
	0x64, 0x42, 0x06, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x22, 0x1b, 0x0a, 0x07, 0x47, 0x69, 0x74,
	...
	0x72, 0x69, 0x65, 0x73, 0x22, 0x2e, 0x0a, 0x04, 0x46, 0x69, 0x6c, 0x65, 0x12, 0x12, 0x0a, 0x04,
	...
	0x73, 0x12, 0x2a, 0x0a, 0x06, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x12, 0x0e, 0x2e, 0x63, 0x6f,
	0x6e, 0x74, 0x65, 0x6e, 0x74, 0x2e, 0x51, 0x75, 0x65, 0x72, 0x79, 0x1a, 0x10, 0x2e, 0x63, 0x6f,
	0x6e, 0x74, 0x65, 0x6e, 0x74, 0x2e, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x73, 0x12, 0x2e, 0x0a,
...
var file_content_content_proto_goTypes = []interface{}{
	...
	(*GitRepo)(nil),       // 12: content.GitRepo
...
var file_content_content_proto_depIdxs = []int32{
	...
	22, // 10: content.Data.text:type_name -> content.Text
	21, // 11: content.Data.file:type_name -> content.File
	23, // 12: content.Data.url:type_name -> content.URL
	16, // 13: content.Normalized.article:type_name -> content.Article
	17, // 14: content.Normalized.html:type_name -> content.HTML
	26, // 15: content.Normalized.transcript:type_name -> content.Transcript
	18, // 16: content.Normalized.readme:type_name -> content.ReadMe
	19, // 17: content.Transformed.summary:type_name -> content.Summary
	20, // 18: content.Transformed.categories:type_name -> content.Categories
	24, // 19: content.Segment.tokens:type_name -> content.Token
	25, // 20: content.Transcript.segments:type_name -> content.Segment
	6,  // 21: content.ContentService.Save:input_type -> content.Contents
	7,  // 22: content.ContentService.Search:input_type -> content.Query
	11, // 23: content.ContentService.Analyze:input_type -> content.Content
	5,  // 24: content.ContentService.Delete:input_type -> content.ContentIDs
	0,  // 25: content.ContentService.GetTags:input_type -> content.TagRequest
	1,  // 26: content.ContentService.Vote:input_type -> content.VoteRequest
	5,  // 27: content.ContentService.Save:output_type -> content.ContentIDs
	8,  // 28: content.ContentService.Search:output_type -> content.Results
	6,  // 29: content.ContentService.Analyze:output_type -> content.Contents
	5,  // 30: content.ContentService.Delete:output_type -> content.ContentIDs
	3,  // 31: content.ContentService.GetTags:output_type -> content.Tags
	2,  // 32: content.ContentService.Vote:output_type -> content.VoteResponse
