...
type UserServiceClient interface {
	...
	UpdateConfig(ctx context.Context, in *Config, opts ...grpc.CallOption) (*Empty, error)
	CreateGroupInvite(ctx context.Context, in *Group, opts ...grpc.CallOption) (*GroupInvite, error)
...
func (c *userServiceClient) UpdateConfig(ctx context.Context, in *Config, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
...
func (c *userServiceClient) CreateGroupInvite(ctx context.Context, in *Group, opts ...grpc.CallOption) (*GroupInvite, error) {
	out := new(GroupInvite)
...
func (c *userServiceClient) GetGroups(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Groups, error) {
	out := new(Groups)
...
func (c *userServiceClient) DeleteGroup(ctx context.Context, in *Group, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
...
type UserServiceServer interface {
	...
	UpdateConfig(context.Context, *Config) (*Empty, error)
	CreateGroupInvite(context.Context, *Group) (*GroupInvite, error)
...
func (UnimplementedUserServiceServer) UpdateConfig(context.Context, *Config) (*Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateConfig not implemented")
}
func (UnimplementedUserServiceServer) CreateGroupInvite(context.Context, *Group) (*GroupInvite, error) {
...
func (UnimplementedUserServiceServer) GetGroups(context.Context, *Empty) (*Groups, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetGroups not implemented")
}
func (UnimplementedUserServiceServer) DeleteGroup(context.Context, *Group) (*Empty, error) {
...
func _UserService_CreateGroupInvite_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).CreateGroupInvite(ctx, req.(*Group))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _UserService_GetGroups_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).GetGroups(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
