...
type PythonClient interface {
	...
	QueryIndex(ctx context.Context, in *IndexQuery, opts ...grpc.CallOption) (*QueryResult, error)
}
...
func (c *pythonClient) QueryIndex(ctx context.Context, in *IndexQuery, opts ...grpc.CallOption) (*QueryResult, error) {
	out := new(QueryResult)
...
// All implementations should embed UnimplementedPythonServer
...
type PythonServer interface {
	...
	QueryIndex(context.Context, *IndexQuery) (*QueryResult, error)
}

// UnimplementedPythonServer should be embedded to have forward compatible implementations.
...
func (UnimplementedPythonServer) QueryIndex(context.Context, *IndexQuery) (*QueryResult, error) {
...
func _Python_QueryIndex_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PythonServer).QueryIndex(ctx, req.(*IndexQuery))
	}
	return interceptor(ctx, in, info, handler)
}
