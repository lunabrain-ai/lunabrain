...
func (s *URLNormalizer) Normalize(nurl string, crawl bool) ([]*types.Content, error) {
...
func (s *URLNormalizer) normalizeYoutube(url *url.URL) ([]*types.Content, error) {
...
func (s *URLNormalizer) normalizeGithub(url *url.URL) ([]*types.Content, error) {
...
func NewURLNormalizer(client python.PythonClient, scraper scrape.Scraper, crawler scrape.Crawler) (*URLNormalizer, error) {
