...
func (vu *VoteUpdate) SetContentID(id uuid.UUID) *VoteUpdate {
	vu.mutation.SetContentID(id)
	return vu
}

// SetNillableContentID sets the "content" edge to the Content entity by ID if the given value is not nil.
func (vu *VoteUpdate) SetNillableContentID(id *uuid.UUID) *VoteUpdate {
	if id != nil {
		vu = vu.SetContentID(*id)
	}
	return vu
}

// SetContent sets the "content" edge to the Content entity.
func (vu *VoteUpdate) SetContent(c *Content) *VoteUpdate {
	return vu.SetContentID(c.ID)
}
...
// SetContentID sets the "content" edge to the Content entity by ID.
func (vuo *VoteUpdateOne) SetContentID(id uuid.UUID) *VoteUpdateOne {
	vuo.mutation.SetContentID(id)
	return vuo
}

// SetNillableContentID sets the "content" edge to the Content entity by ID if the given value is not nil.
func (vuo *VoteUpdateOne) SetNillableContentID(id *uuid.UUID) *VoteUpdateOne {
	if id != nil {
		vuo = vuo.SetContentID(*id)
	}
	return vuo
}

// SetContent sets the "content" edge to the Content entity.
func (vuo *VoteUpdateOne) SetContent(c *Content) *VoteUpdateOne {
	return vuo.SetContentID(c.ID)
}
