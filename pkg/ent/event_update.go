...
func (eu *EventUpdate) SetData(e *event.Metric) *EventUpdate {
	eu.mutation.SetData(e)
	return eu
}
...
func (eu *EventUpdate) sqlSave(ctx context.Context) (n int, err error) {
	_spec := sqlgraph.NewUpdateSpec(entevent.Table, entevent.Columns, sqlgraph.NewFieldSpec(entevent.FieldID, field.TypeUUID))
	...
	if value, ok := eu.mutation.Data(); ok {
		_spec.SetField(entevent.FieldData, field.TypeJSON, value)
	}
	if value, ok := eu.mutation.CreatedAt(); ok {
		_spec.SetField(entevent.FieldCreatedAt, field.TypeTime, value)
	}
...
// SetData sets the "data" field.
func (euo *EventUpdateOne) SetData(e *event.Metric) *EventUpdateOne {
	euo.mutation.SetData(e)
	return euo
}
