...
func (ec *EventCreate) SetData(e *event.Metric) *EventCreate {
	ec.mutation.SetData(e)
	return ec
}
...
func (ec *EventCreate) createSpec() (*Event, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(entevent.Table, sqlgraph.NewFieldSpec(entevent.FieldID, field.TypeUUID))
	)
