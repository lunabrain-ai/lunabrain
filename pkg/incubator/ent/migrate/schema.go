...
var (
	...
	// ContentVotesColumns holds the columns for the "content_votes" table.
	ContentVotesColumns = []*schema.Column{
		{Name: "content_id", Type: field.TypeUUID},
		{Name: "vote_id", Type: field.TypeUUID},
	}
	// ContentVotesTable holds the schema information for the "content_votes" table.
	ContentVotesTable = &schema.Table{
		Name:       "content_votes",
		Columns:    ContentVotesColumns,
		PrimaryKey: []*schema.Column{ContentVotesColumns[0], ContentVotesColumns[1]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "content_votes_content_id",
				Columns:    []*schema.Column{ContentVotesColumns[0]},
				RefColumns: []*schema.Column{ContentsColumns[0]},
				OnDelete:   schema.Cascade,
			},
			{
				Symbol:     "content_votes_vote_id",
				Columns:    []*schema.Column{ContentVotesColumns[1]},
...
func init() {
	...
	ContentVotesTable.ForeignKeys[0].RefTable = ContentsTable
	ContentVotesTable.ForeignKeys[1].RefTable = VotesTable
